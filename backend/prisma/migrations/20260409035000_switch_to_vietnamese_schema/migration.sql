-- Remove the previously applied English schema
...
DROP TYPE IF EXISTS "TopicType" CASCADE;
DROP TYPE IF EXISTS "JoinStatus" CASCADE;
DROP TYPE IF EXISTS "GroupRole" CASCADE;
DROP TYPE IF EXISTS "ResearchGroupStatus" CASCADE;
DROP TYPE IF EXISTS "RegistrationStatus" CASCADE;
DROP TYPE IF EXISTS "ResearchAreaStatus" CASCADE;
